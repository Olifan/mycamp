		...
		<div className={styles.aboutPage}>
			...
			<div className={styles.aboutPageContent}>
				...
				<CardWithText
					...
					text={
						<ReactMarkdown rehypePlugins={[rehypeRaw]} children={data && data.data.attributes.RestWithUs.description} />
					}
					icon="https://assets.website-files.com/62e852b3b3432f63a22b8844/62ea61cb131e422cf017262d_streamlinehq-shopping-business-target-money-shopping-250.SVG"
				/>
				...
				<CardWithText
					...
					text={
						<ReactMarkdown rehypePlugins={[rehypeRaw]} children={data && data.data.attributes.Questions.description} />
					}
					icon="https://assets.website-files.com/62e852b3b3432f63a22b8844/62ea61cb131e422cf017262d_streamlinehq-shopping-business-target-money-shopping-250.SVG"
				/>
			</div>
